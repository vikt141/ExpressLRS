...
const fhss_config_t domains[] = {
    ...
    {"C300",  FREQ_HZ_TO_REG_VAL(370000000), FREQ_HZ_TO_REG_VAL(400000000), 20, 385000000},
    {"C400",  FREQ_HZ_TO_REG_VAL(430000000), FREQ_HZ_TO_REG_VAL(460000000), 20, 445000000},
    {"C500",  FREQ_HZ_TO_REG_VAL(535000000), FREQ_HZ_TO_REG_VAL(565000000), 20, 550000000},
    {"C700",  FREQ_HZ_TO_REG_VAL(730000000), FREQ_HZ_TO_REG_VAL(750000000), 20, 740000000},
    {"C800",  FREQ_HZ_TO_REG_VAL(860000000), FREQ_HZ_TO_REG_VAL(880000000), 20, 870000000},
    {"C1000",  FREQ_HZ_TO_REG_VAL(990000000), FREQ_HZ_TO_REG_VAL(1010000000), 20, 1000000000},
    {"C2200",  FREQ_HZ_TO_REG_VAL(2150000000), FREQ_HZ_TO_REG_VAL(2200000000), 20, 2175000000},
    {"C2400",  FREQ_HZ_TO_REG_VAL(2350000000), FREQ_HZ_TO_REG_VAL(2400000000), 20, 2375000000},
    {"C2600",  FREQ_HZ_TO_REG_VAL(2550000000), FREQ_HZ_TO_REG_VAL(2600000000), 20, 2575000000},
};
